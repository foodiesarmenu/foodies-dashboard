...
import { Card, Badge, Rating, Modal, Label, TextInput, Textarea, Button } from "flowbite-react";
  ...
  return (
    <>
      ...
      <div className="flex justify-between m-2">
        <h1 className="text-white text-3xl">Tags</h1>
      </div>
      <div className="flex overflow-x-auto whitespace-nowrap hide-scrollbar">
        {menu.map((menuItem, index) => (
          <Card
            ...
            key={index}
            className="max-w-sm m-2 flex-shrink-0"
            imgSrc={menuItem.meals[0].image}
            horizontal
          >
